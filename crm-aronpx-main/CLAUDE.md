...
1. NEVER make changes without explaining what you will do first
2. ALWAYS ask for approval before editing any file
3. NEVER deploy to Railway automatically - always ask first
4. NEVER change .env files
5. Make ONE change at a time, not multiple files together