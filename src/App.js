        ...
        {filtered.map(function(lead){
          ...
          return <div key={lid} onClick={function(){setSelected(lead);}} style={{ background:"#fff", borderRadius:12, padding:"12px 14px", border:"1px solid #E8ECF1", borderRight:isVIP?"3px solid #F59E0B":"1px solid #E8ECF1", cursor:"pointer" }}>
            ...
            <div style={{ display:"flex", gap:6, marginTop:8 }}>
              <a href={"tel:"+lead.phone} onClick={async function(e){e.stopPropagation();try{await apiFetch("/api/activities","POST",{leadId:gid(lead),type:"call",note:"📞 Call initiated — "+lead.phone},p.token);}catch(ex){}}} style={{ flex:1, padding:"6px", borderRadius:8, background:"#DCFCE7", color:"#15803D", fontSize:11, fontWeight:600, textDecoration:"none", display:"flex", alignItems:"center", justifyContent:"center", gap:4 }}><Phone size={11}/> {t.call}</a>
