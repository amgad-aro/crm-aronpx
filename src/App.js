...
var LeadsPage = function(p) {
  ...
  return <div style={{ padding:"18px 16px 40px" }}>
    ...
    {/* Table */}
      {p.isMobile&&!selected?<div style={{ display:"flex", flexDirection:"column", gap:10, padding:"4px 0" }}>
        ...
        {filtered.map(function(lead){
          ...
          return <div key={lid} onClick={function(){setSelected(lead);}}
            style={{ background:"#fff", borderRadius:16, padding:"16px", border:"1px solid #E8ECF1",
              borderLeft:isVIP?"4px solid #F59E0B":so.color?"4px solid "+so.color+"40":"4px solid #E8ECF1",
            ...
            <div style={{ display:"flex", gap:8 }}>
              <a href={"tel:"+lead.phone} onClick={async function(e){e.stopPropagation();try{await apiFetch("/api/activities","POST",{leadId:gid(lead),type:"call",note:"📞 Call initiated"},p.token);}catch(ex){}}}
                style={{ flex:1, padding:"10px", borderRadius:10, background:C.success, color:"#fff", fontSize:13, fontWeight:700, textDecoration:"none", display:"flex", alignItems:"center", justifyContent:"center", gap:6 }}>
              ...
              <a href={"https://wa.me/2"+lead.phone.replace(/^0/,"")} target="_blank" rel="noreferrer" onClick={function(e){e.stopPropagation();}}
                style={{ flex:1, padding:"10px", borderRadius:10, background:"#25D366", color:"#fff", fontSize:13, fontWeight:700, textDecoration:"none", display:"flex", alignItems:"center", justifyContent:"center", gap:6 }}>
